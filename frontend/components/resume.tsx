...
export default function Resume() {
  return (
    <section id="resume" className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl dark:text-white">Resume</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-6 space-y-2">
                ...
                <p className="text-gray-700 dark:text-gray-300">Florida State University</p>
                <p className="text-gray-600 dark:text-gray-400">Expected Graduation: December 2026</p>
                <p className="text-gray-600 dark:text-gray-400">GPA: 3.87/4.0</p>
              </div>
            </div>
          </div>
